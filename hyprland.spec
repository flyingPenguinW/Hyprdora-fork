...
URL:            https://github.com/flyingPenguinW/Hyprdora-fork
%if 0%{?bumpver}
...
%changelog
* Wed Jun 10 2026 flyingPenguinW - 0.51.1^58.gitff50dc3
- Forked from hyprwm/Hyprland to flyingPenguinW/Hyprdora-fork
- Changed default terminal to ghostty and launcher to rofi
